...
//this addAction["<t color='#38c12e'>5-1 Delta</t>", {player execVM "Loadouts\RecceMarksmanD.sqf";}, [],8,false,false,"","_this distance _target < 10"];
...
if (_PlayerBackpack isEqualTo "") then {
	...
	//Removed due to never using it_this addItemToBackpack "H2H_acc_bayo_M12";
...
hint "Reconnaissance Marksman Delta kit successfully loaded!";
sleep 15;
hintSilent "";
