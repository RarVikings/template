...
if (_PlayerBackpack isEqualTo "") then {
	...
	for "_i" from 1 to 4 do {_this addItemToBackpack "UK3CB_BAF_762_L42A1_20Rnd";};
	for "_i" from 1 to 4 do {_this addItemToBackpack "UK3CB_BAF_762_L42A1_20Rnd_T";};
	for "_i" from 1 to 2 do {_this addItemToBackpack "UK3CB_BAF_SmokeShell";};
	for "_i" from 1 to 2 do {_this addItemToBackpack "ACE_Tripod";};
...
hint "5-1 Marksman kit successfully loaded!";
sleep 15;
hintSilent "";
